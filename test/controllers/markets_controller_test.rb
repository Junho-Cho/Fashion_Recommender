...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { content: @market.content, title: @market.title } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { content: @market.content, title: @market.title } }
